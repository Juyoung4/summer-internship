...
public final class PagingAction extends TagSupport {
	...
	private String getAHref(int nPage, String title){
		...
		if("start".equals(title)){
			...
			sb.append("<li class='page-item'><a class='page-link' aria-label='Previous' href='#none' onClick='goPage(").append(nPage).append(")'  ><span aria-hidden='true'>&laquo;</span><span class='sr-only'>Previous</span></a></li>");
		} else if("next".equals(title)){
			sb.append("<li class='page-item'><a class='page-link' aria-label='Next' href='#none' onClick='goPage(").append(nPage).append(")'  ><span aria-hidden='true'>&raquo;</span><span class='sr-only'>Next</span></a></li>");
		} else if("end".equals(title)){
			
		} else {
			sb.append("<li class='page-item").append(css).append("'><a href='#none' onClick='goPage(").append(nPage).append(")'>");		
			sb.append(title);
			sb.append("</a></li>\n");
		}
