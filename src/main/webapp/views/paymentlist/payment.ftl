...
<form class="form-inline" name="PaymentListFrm" id="PaymentListFrm" method="post" >
	<input type="hidden" id="PaymentSeq" name="PaymentSeq" value="" />
</form>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<button type="button" style="float:right;" class="btn btn-default">검색</button>
										</td>
									</tr> 
								</tbody>
							</table>
