    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<input type="hidden" id="useTicketStatus" name="useTicketStatus" value="" />
			...
			<button type="button" class="btn btn-default"  style="float:right;" onclick="fn_releaseEV();">이벤트 해제</button>
		</form>
      </div>
      <!-- Footer -->
							...
							<table class="table table-striped jambo_table bulk_action">
								...
								<tbody>
									...
									<tr style="cursor:pointer;">
										...
										<#if rMap.eventname != "">
											<td class="even pointer">${rMap.eventname} &nbsp;${rMap.discountrate}%&nbsp;&nbsp;<button type="button" data-toggle="modal" data-target="#modalevent" data-id='${rMap.useTicketSeq}' class="btn btn-success">설정</button> </td>
										<#else>
