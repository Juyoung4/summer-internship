...
<script type="text/javascript">
	...
	//등록 버튼 클릭 시 evnent+이용권 modal창 띄움
	$(document).ready(function(){
		$('#modalEvUse').on('show.bs.modal', function(event) {          
            var result = $(event.relatedTarget).data('id');
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
	      ...
	      <tbody>
	        <tr>
	          <td>*	이용권 명</td><td>&nbsp;: &nbsp;&nbsp;Ipsum</td>
	        </tr>
	        <tr>
	          <td>* 적용 기간</td><td>&nbsp;: &nbsp;&nbsp;Ipsum</td>
	        </tr>
	        <tr>
	          <td>*	가격</td><td>&nbsp;:&nbsp;&nbsp; Ipsum</td>
	        </tr>
	        <tr>
	          <td>*	이벤트</td><td>&nbsp;:&nbsp;&nbsp; Ipsum</td>
	        </tr>
	      </tbody>
	    </table>
      </div>
							...
							<table class="table table-striped jambo_table bulk_action">
								...
								<tbody>
									...
									<tr style="cursor:pointer;">
										...
										<td> 
											<button type="button" data-toggle="modal" data-target="#modalEvUse" data-id='${rMap.useTicketSeq}' class="btn btn-default">${ticketStatus2}</button>
