...
<script type="text/javascript">
	...
	function fn_changeEvYn(){
		eventInsertFrm.EventName.value=$("#event").val();
		eventInsertFrm.EventPeriodS.value=$("#periods").val();
		eventInsertFrm.EventPeriodF.value=$("#periodf").val();
		eventInsertFrm.DiscountRate.value=$("#discount").val();
		ajaxFormExecute("eventInsertFrm", "/eventmanage/ajaxeventUpdate", "post", false, false, ajaxReturnupdate);
	}
      ...
      <div class="modal-body">
        ...
        <table>
	      <tbody>
	        ...
	        <tr>
	          <td>* 적용 기간</td><td>&nbsp;:&nbsp;&nbsp;&nbsp;<input type="date" id="periods"/> ~ <input type="date" id="periodf"/></td>
	        </tr>
	        <tr>
								...
								<tbody>
									...
									<#list eventList as eMap>
										<tr style="cursor:pointer;">
											...
											<td> <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalChEv" data-id='${eMap.eventseq}' data-eventname='${eMap.eventname}' data-periods='${eMap.eventperiods}' data-periodf='${eMap.eventperiodf}' data-discount='${eMap.discountrate}' >변경</button> </td>
										</tr>
									<#assign eNum = eNum - 1/>
									</#list>
									<#else>
