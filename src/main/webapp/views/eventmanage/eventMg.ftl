							...
							<table class="table table-striped jambo_table bulk_action">
								<tbody>
									...
									<tr>
										...
										<td>
										<input type="date" id="EventPeriodS" name="date" />
										~
										<input type="date" id="EventPeriodF" name="date" />
										</td>
									</tr> 
									<tr>
									...
									<tr>
										...
										<button type="button" style="float:right;" class="btn btn-success">저장</button>
										</td>
									</tr> 
								</tbody>
							</table>
